...
#   Update the UserPrincipalName for 'Klemen' to include an extra '@' character
#   Update the emailAddress for 'Lara' to 'lara@adatum.com?'
#   Update the emailAddress for 'Logan' to 'Logan@adatum.com@'
#   Update the emailAddress for 'Maj' to “ “

# Update UPN for 'Klemen'
...
If ($upn.UserPrincipalName -notlike "*@@*"){
	...
	Write-Host "Klemen was updated successfully"
} Else {
	Write-Host "Klemen was ALREADY updated"
}

# Update emailAddress for 'Lara'
...
If ($emailLara.emailAddress -notlike "Lara@adatum.com"){
	...
	Write-Host "Lara was updated successfully"
} Else {
	Write-Host "Lara was ALREADY updated"
}

# Update emailAddress for 'Logan'
$emailLogan = Get-ADUser Logan -Properties emailAddress | Select emailAddress
If ($emailLogan.emailAddress -notlike "Logan@adatum.com"){
	Set-ADUser Logan -emailAddress Logan@adatum.com@
	Write-Host "Logan was updated successfully"
} Else {
	Write-Host "Logan was ALREADY updated"
}


# Update emailAddress for 'Maj'
...
If ($emailMaj.emailAddress -notlike " "){
	...
	Write-Host "Maj was updated successfully"
} Else {
	Write-Host "Maj was already updated"
}
# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUXdr5pmvVONix7v7XZNrAucqo
# 65KgghhlMIIEwzCCA6ugAwIBAgITMwAAAMWWQGBL9N6uLgAAAAAAxTANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFPCIFm3GtKMCqzH+qoZQGJyx3BgqMF4GCisG
...
# SIb3DQEBAQUABIIBAKBwLaFCTiqU2edy9+wXlF8Qn/L2Spz92jPbme13XeWfRgzt
# iwUUuYGr47wPB/xyoc599jIz0uEB1zhFpdMeErpp4iYejq2vFFWRMDQKTYsHhZ89
# 0KagIfibPqDr9BLW1cFq+g32yLWks5Ne6K7l4b1MXrhw78LFG14UpETcRGHK2GpA
# IS9yy0YC3i28J69LFdjCvI0Ii4zmk81ptgYX0+rLIFC5jAuD7msZjLklxjuj8YeO
# 0TQNvOT/Vgo6nr937IqGbtI0Kn5NHqaI67dHBVwVxSnKtLW1gXiL7rOI15PtBUGd
# Vt8QFKgMk/zpWQ7akHtMJWgiO35YDcku4956unyhggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNzA3MDMxNTAzNDhaMCMGCSqGSIb3DQEJBDEW
# BBSzJdqlw/RHcSzMqmKKMvgAJIpK6zANBgkqhkiG9w0BAQUFAASCAQBE5rR5hqQA
# 1Zsk2eO5neosRwtBJlBeGSaLzfXAnrDoBQil0cF1JAwpicU7UVtIaepkT/R9jUoR
# pPE80MhUUFRMNNEVi6tZU7HdLCxhsb0u0tAGEVokKbmMGKsOJ/5oQfCwMSUAX3f/
# 5qm6j48IN3vvu4GhlNduLgSo2jjz9UIwJvwcXxfm4vdBQX9P68zWoFudsEL1Y/fR
# sdZf7IBGwKifaICfSGVl85fVF9fLW+i8jxbYX9K/Sulo8MpRv+2+2LARE4gAhPr+
# /OMSqN8kSgd/dlKWbFll10EiarOkWZtax4Wj+FdPAuwyz2zB2BWvHvTBIhDT68et
# /9j1VvhidPRD
