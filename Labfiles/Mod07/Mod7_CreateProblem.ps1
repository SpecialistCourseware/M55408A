# This script is to be used in lab 7 of MOC Course 10997A - Office 365 ProPlus 
# This script will make the following changes 
#   Remove the Office365 ProPlus license for the user Beth Burke
#   Uninstall Office 365 ProPlus on LON-CL2 and LON-CL3
#   Disable the link for the GPO deploying Office 365 ProPlus
...
$User = Get-MsolUser -All | Where { $_.UserPrincipalName.ToLower().StartsWith("beth")}
...
{
    $O365Licences = New-MsolLicenseOptions -AccountSkuId $AllLicensingPlans[$i].AccountSkuId -DisabledPlans "OFFICESUBSCRIPTION"
    Set-MsolUserLicense -UserPrincipalName $O365User -LicenseOptions $O365Licences
}

Invoke-Command -ComputerName LON-CL2,LON-CL3 -ScriptBlock {
net use q: \\LON-CL1\Labfiles\Mod07 /u:adatum\administrator Pa55w.rd
q:\setup.exe /configure q:\uninstall.xml} > $null

$OU = Get-ADOrganizationalUnit -filter 'Name -like "Adatum*"'
$GPOLinks = (Get-GPInheritance -target $OU).GpoLinks
Set-GPLink -Name $GPOLinks.DisplayName -Target $OU -LinkEnabled No > $null
# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUig2rqvN5U56tXO0aX7bNZRyn
# 5eagghhlMIIEwzCCA6ugAwIBAgITMwAAAMZ4gDYBdRppcgAAAAAAxjANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFPj6f7b2C0GWKxrZiiiX98C+o2B9MF4GCisG
...
# SIb3DQEBAQUABIIBAB/69Na/5ljqL+Z4zSbwAYmDu3BAR/O1UN3FeKHCdK0LTDg1
# qSxuFeE81uR7oM47gDMVG8CqO/E2D6dmHzAmDPmXZHWyOLka3YAaVUzgop3ggvF5
# xSdjIvqg1Zq/WR1znwPs6KPeQxWtyFw/uawpm6lbhEMrm9xHuJbYS60QSjjly3ig
# B4o2wIMrHGhtLIDtt1+OlC4krmnVnN3jBlXI1qPlxf8cxyeRKQ2/n0y8QUg81wb/
# xNU491pfjgkrJUsSqV7wD2a8QU0O7z3NM+uo8uEsL1aESH1Wf1WzQn+Oindv5Qvt
# bkIRWxHbHoQUaX9uE1LtxkGlFwFFC01aXhLr5xahggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNzA3MTYxODIzNDVaMCMGCSqGSIb3DQEJBDEW
# BBTcuP5N8GSUrMAosWu4F95PE56ZazANBgkqhkiG9w0BAQUFAASCAQA3/X2MbN23
# 90JG5XV4NlWIsK4EOlEplI5egWFcrA9yLyQA2XPPL+VvtKm5KViLpiguns1FMhGp
# bE+RqIeP5+ntMyE1BCrjRpvjW2jpRmRzI+xjsXZuWSA8px6dXbvDpKVYblWgCP9W
# s2SPz3T5XhzYmP1r50UTA3qGZeiPnb3kIP0cgIDDhe+vOPwu/Pcz/yJQ1KToO3lD
# eLNJHz++4kSQmhKt5aL9/tEQID29dNpCmxj4/zEKBH6mBYLq3j+f/cy8h4NNvJCM
# YUnBtgOig03hFI/8D0RED6aX6In7wnipAmgNxMmVfdA5m60mDlb99VqfVBVlalsI
# Fn+k9DHMnr8y
